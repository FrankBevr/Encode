...
let images = {
  back: "https://gateway.ipfs.io/ipfs/QmRtFr9E1D9LB9PovuH3HsmFXxBtLKvtcTfx5a1frxrixS",
  bump: "https://gateway.ipfs.io/ipfs/QmRtFr9E1D9LB9PovuH3HsmFXxBtLKvtcTfx5a1frxrixS",
  edge: "https://gateway.ipfs.io/ipfs/QmRtFr9E1D9LB9PovuH3HsmFXxBtLKvtcTfx5a1frxrixS",
  front: "https://gateway.ipfs.io/ipfs/QmRtFr9E1D9LB9PovuH3HsmFXxBtLKvtcTfx5a1frxrixS",
  ribbon: "https://gateway.ipfs.io/ipfs/QmRtFr9E1D9LB9PovuH3HsmFXxBtLKvtcTfx5a1frxrixS",
  shine: "https://gateway.ipfs.io/ipfs/QmRSdGL3iyzPZbq5i6jxxeZD62XoUZ3ijeBTYDuqAiKrgc",
  specular: "https://gateway.ipfs.io/ipfs/QmRtFr9E1D9LB9PovuH3HsmFXxBtLKvtcTfx5a1frxrixS"
}
...
const Box = function () {
  ...
  useEffect(() => { 
    ...
    if (boxTag.current) {
      ...
      //Frank - No Background
      let amount = 0
      const cylinders = Array.from({length: amount}, (x, i) => (i - amount / 2)).map(i => {
